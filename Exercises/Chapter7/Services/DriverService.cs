...
public class DriverService : IDriverService
{
    ...
    {
        var driver = new Driver { FullName = request.FullName };

        await _unitOfWork.Drivers.AddAsync(driver);
        await _unitOfWork.SaveChangeAsync();

        return ServiceResult<CreateDriverResponse>.Success(
            new CreateDriverResponse { Id = driver.Id }
        );
    }

    public async Task<ServiceResult<IEnumerable<GetDriverByIdResponse>>> GetAllAsync()
    {
        var drivers = await _unitOfWork.Drivers.GetAllAsync();
        var data = drivers.Select(driver => new GetDriverByIdResponse
        {
            Id = driver.Id,
        ...
        return ServiceResult<IEnumerable<GetDriverByIdResponse>>.Success(data);
    }
    ...
    public async Task<ServiceResult<GetDriverByIdResponse>> GetByIdAsync(int id)
    {
        ...
        return ServiceResult<GetDriverByIdResponse>.Success(
